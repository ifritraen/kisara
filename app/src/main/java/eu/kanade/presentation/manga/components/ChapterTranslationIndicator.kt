...
private fun NotTranslatedIndicator(
    ...
    Box(
        ...
        Icon(
            ...
            contentDescription = stringResource(KMR.strings.manga_translate),
            modifier = Modifier.size(TranslationIndicatorSize),
...
private fun TranslatingIndicator(
    ...
    Box(
        ...
        CircularProgressIndicator(
            modifier = TranslationIndicatorModifier,
            color = strokeColor,
            strokeWidth = TranslationIndicatorStrokeWidth,
        ...
        Icon(
            ...
            modifier = TranslatingIndicatorModifier,
            tint = strokeColor,
        )
    }
}
...
private val TranslationIndicatorSize = 23.dp
private val TranslationIndicatorPadding = 2.dp

// To match composable parameter name when used later
private val TranslationIndicatorStrokeWidth = TranslationIndicatorPadding

private val TranslationIndicatorModifier = Modifier
    .size(TranslationIndicatorSize)
    .padding(TranslationIndicatorPadding)
private val TranslatingIndicatorModifier = Modifier
    .size(TranslationIndicatorSize - 7.dp)
